    ...
    module Admin
      class Markets < Grape::API
        ...
        params do
          ...
          optional :id,
                   type: { value: String, message: 'admin.market.non_string_id' },
                   values: { value: -> { ::Market.pluck(:symbol) }, message: 'admin.market.invalid_market_id' },
                   desc: -> { API::V2::Admin::Entities::Market.documentation[:id][:desc] }
          optional :symbol,
                   type: { value: String, message: 'admin.market.non_string_symbol' },
                   values: { value: -> { ::Market.pluck(:symbol) }, message: 'admin.market.invalid_market_symbol' },
                   desc: -> { API::V2::Admin::Entities::Market.documentation[:symbol][:desc] }
          optional :type,
                   type: { value: String, message: 'admin.market.non_string_market_type' },
                   values: { value: -> { ::Market::TYPES }, message: 'admin.market.invalid_market_type' },
